  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested list" do
        ...
        List.any_instance.should_receive(:update).with({ "store" => "MyString" })
        put :update, {:id => list.to_param, :list => { "store" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the list as @list" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        List.any_instance.stub(:save).and_return(false)
        put :update, {:id => list.to_param, :list => { "store" => "invalid value" }}, valid_session
        assigns(:list).should eq(list)
      end
